    ...
    <template #form>
      ...
      <el-form-item v-if="!meta.config?.orderStatus" prop="orderStatus">
        <FetchSelect
          ...
          :postData="{ codeParam: 'DOCTOR_ORDER_STATUS' }"
          textKey="codeValue"
          valueKey="codeKey"
          :multiple="true"
        />
      ...
      <el-form-item prop="orderType">
        <FetchSelect
          placeholder="订单类型"
          v-model="searchController.formModel.orderType"
          api="/web/sys/code/getSysCodeByParam"
          :postData="{ codeParam: 'DOCTOR_ORDER_TYPE' }"
          textKey="codeValue"
          valueKey="codeKey"
        />
      </el-form-item>
      ...
      <el-form-item prop="payStatus">
        <FetchSelect
          ...
          api="/web/sys/code/getSysCodeByParam"
          :postData="{ codeParam: 'DOCTOR_ORDER_PAY_STATUS' }"
          textKey="codeValue"
          valueKey="codeKey"
        />
      </el-form-item>
