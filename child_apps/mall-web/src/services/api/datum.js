...
const api = {
  ...
  getMonopolyGoodsList: '/web/staff/goods/getMonopolyGoodsList', //获取商品列表
  addGroupMonopolyGoods: '/web/staff/group/addGroupMonopolyGoods', //批量专营
  delGroupMonopolyGoods: '/web/staff/group/delGroupMonopolyGoods', //取消专营
}
export default api
