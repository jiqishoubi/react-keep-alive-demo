...
(function(g) {
  ...
  v(z.prototype, {
    onContainerDblClick: function(a) {
      ...
      b.isInsidePlot(a.chartX - b.plotLeft, a.chartY - b.plotTop) &&
        b.mapZoom(0.5, b.xAxis[0].toValue(a.chartX), b.yAxis[0].toValue(a.chartY));
    },
    onContainerMouseWheel: function(a) {
      ...
      b.isInsidePlot(a.chartX - b.plotLeft, a.chartY - b.plotTop) &&
        b.mapZoom(c > 0 ? 2 : 0.5, b.xAxis[0].toValue(a.chartX), b.yAxis[0].toValue(a.chartY));
    },
  });
      ...
      l(
        ...
        function(c) {
          var d = c[0],
            c = c[1];
          a[d] + a[c] > b[d] + b[c] &&
            (a[c] > b[c] ? ((a[c] = b[c]), (a[d] = b[d])) : (a[d] = b[d] + b[c] - a[c]));
          a[c] > b[c] && (a[c] = b[c]);
          a[d] < b[d] && (a[d] = b[d]);
        },
      );
  ...
  k.map = g.extendClass(k.scatter, {
    ...
    drawLegendSymbolGradient: function(a, b) {
      ...
      e = b.toText.getBBox();
      h
        ? ((a.offsetWidth = f.width + j.width + e.width + c * 2 + d), (a.itemY = i + d))
    ...
    translatePath: function(a) {
      ...
      for (e = a.length; e--; )
        typeof a[e] === 'number' &&
          ((a[e] = b ? Math.round(c.translate(a[e])) : Math.round(d.len - d.translate(a[e]))),
          (b = !b));
      return a;
    },
    setData: function() {
    ...
    translateColors: function(a, b) {
      ...
      l(this.data, function(g) {
        ...
        if (d)
          ...
          e &&
            k !== void 0 &&
            ((m = 1 - (b - k) / (b - a)), (l = k === null ? c.nullColor : x(i, h, m)));
      ...
      if (!a)
        (a = Math.min(d.width / b.width, d.height / b.height)),
          ...
          l(this.points, function(a) {
            a.graphic
              .attr(c.shapeArgs)
              .animate({ scaleX: 1, scaleY: 1, translateX: 0, translateY: 0 }, e);
          }),
          delete this.animate;
    },
  ...
  k.mapline = g.extendClass(k.map, {
    type: 'mapline',
    pointAttrToOptions: { stroke: 'color', 'stroke-width': 'lineWidth', fill: 'backgroundColor' },
  ...
  g.Map = function(a, b) {
    ...
    d = a.series;
    a.series = null;
    a = p({ chart: { type: 'map', panning: 'xy' }, xAxis: c, yAxis: p(c, { reversed: !0 }) }, a, {
      chart: { inverted: !1 },
    });
    a.series = d;
