...
(function(root, factory) {
  ...
  /**
   * Web Uploader内部类的详情说明，以下提及的功能类，都可以在`WebUploader`这个变量中访问到。
   *
  ...
  define('widgets/validator', [
    ...
    api.addValidator('duplicate', function() {
      ...
      uploader.on('beforeFileQueued', function(file) {
        var hash =
          file.__hash || (file.__hash = hashString(file.name + file.size + file.lastModifiedDate));
  ...
  define('runtime/html5/imagemeta/exif', [
    ...
    EXIF.getExifValue = function(dataView, tiffOffset, offset, type, length, littleEndian) {
      ...
      dataOffset =
        tagSize > 4 ? tiffOffset + dataView.getUint32(offset + 8, littleEndian) : offset + 8;
      ...
      _renderImageToCanvas: (function() {
        ...
        if (Base.os.ios >= 7) {
          return function(canvas, img, x, y, w, h) {
            ...
            return canvas
              .getContext('2d')
              .drawImage(img, 0, 0, iw * vertSquashRatio, ih * vertSquashRatio, x, y, w, h);
          };
        }
