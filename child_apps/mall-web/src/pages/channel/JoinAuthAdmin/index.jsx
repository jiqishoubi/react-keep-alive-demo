...
const Index = () => {
  ...
  const columns = [
    { title: '成员名称', dataIndex: 'personName', align: 'center' },
    { title: '推广公司', dataIndex: 'orgName', width: 150, align: 'center' },
    {
      title: '联系电话',
    ...
    { title: '成员状态', dataIndex: 'statusName', width: 100, align: 'center' },
    { title: '提交时间', dataIndex: 'createDateStr', align: 'center' },
    // {
    //   title: '操作',
    //   dataIndex: 'options',
    //   width: 80,
    ...
    //           <a
    //             onClick={() => {
    //               approveModalRef.current?.open(record.distributeCode);
    //             }}
    //           >
    //             审核
    //           </a>
            ...
            <Row gutter={[15, 22]} justify="start">
              ...
              <Col>
                <Button
                  ...
                  onClick={() => {
                    approveModalRef.current?.open(selectedRowKeys.join(','))
                  }}
                >
                  批量审核
                </Button>
