...
export async function supplierExportTradeReport(params) {
  let url = '/web/admin/supplier/export/goodsListExport'
...
export async function supplierGetExportInfo(params) {
  let url = '/web/admin/supplier/export/goods/getExportInfo'
  return requestw({
    url,
    data: params,
  })
...
export async function supplierGetPagingList(params) {
  let url = '/web/admin/supplier/export/goods/getPagingList'
  return requestw({
    url,
    data: params,
  })
