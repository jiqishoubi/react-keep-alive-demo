  ...
  this.getHelpXML = function() {
    ...
    for (k = 0; k < b.length; k++)
      try {
        ...
        n.style.cssText =
          'margin: 3px; border: 1px solid black; background:' + o.toHex() + '; color:' + o.toHex();
...
if (!window.console)
  (window.console = {}), (window.console.log = function() {}), (window.console.dir = function() {});
...
(function() {
  function m() {
    ...
    a.ToNumberArray = function(c) {
      for (
        var c = a.trim(a.compressSpaces((c || '').replace(/,/g, ' '))).split(' '), d = 0;
        d < c.length;
        d++
      )
        c[d] = parseFloat(c[d]);
    ...
    a.Element.ElementBase = function(c) {
      ...
      if (c != null && c.nodeType == 1) {
        ...
        if (this.attribute('class').hasValue())
          for (
            var d = a.compressSpaces(this.attribute('class').value).split(' '), e = 0;
            e < d.length;
            e++
          ) {
            b = a.Styles['.' + d[e]];
    ...
    a.Element.RenderedElementBase = function(c) {
      ...
      this.setContext = function(d) {
        ...
        this.attribute('clip-path').hasValue() &&
          ((b = this.attribute('clip-path').Definition.getDefinition()), b != null && b.apply(d));
      ...
      this.renderChildren = function(d) {
        ...
        if (b != null) {
          ...
          if (this.style('marker-mid').Definition.isUrl())
            for (
              var c = this.style('marker-mid').Definition.getDefinition(), e = 1;
              e < b.length - 1;
              e++
            )
      ...
      this.PathParser = new (function(d) {
        ...
        this.getReflectedControlPoint = function() {
          return this.previousCommand.toLowerCase() != 'c' &&
            ...
            ? this.current
            : new a.Point(2 * this.current.x - this.control.x, 2 * this.current.y - this.control.y);
        };
        ...
        this.addMarker = function(b, a, d) {
          d != null &&
            ...
            (this.angles[this.angles.length - 1] = this.points[this.points.length - 1].angleTo(d));
            ...
            case 'A':
              for (; !b.isCommandOrEnd(); ) {
                var g = b.current,
                  ...
                  e = b.getAsCurrentPoint(),
                  n = new a.Point(
                    (Math.cos(f) * (g.x - e.x)) / 2 + (Math.sin(f) * (g.y - e.y)) / 2,
                    (-Math.sin(f) * (g.x - e.x)) / 2 + (Math.cos(f) * (g.y - e.y)) / 2,
                  ),
                ...
                o =
                  ...
                  Math.sqrt(
                    (Math.pow(h, 2) * Math.pow(l, 2) -
                      ...
                      (Math.pow(h, 2) * Math.pow(n.y, 2) + Math.pow(l, 2) * Math.pow(n.x, 2)),
                  );
                isNaN(o) && (o = 0);
    ...
    a.Element.marker = function(c) {
      ...
      this.render = function(d, b, c) {
        ...
        this.attribute('markerUnits').valueOrDefault('strokeWidth') == 'strokeWidth' &&
          d.scale(d.lineWidth, d.lineWidth);
        d.save();
        ...
        d.restore();
        this.attribute('markerUnits').valueOrDefault('strokeWidth') == 'strokeWidth' &&
          d.scale(1 / d.lineWidth, 1 / d.lineWidth);
        this.attribute('orient').valueOrDefault('auto') == 'auto' && d.rotate(-c);
        d.translate(-b.x, -b.y);
      };
    };
      ...
      this.update = function(a) {
        ...
        if (this.duration > this.maxDuration)
          if (this.attribute('repeatCount').value == 'indefinite') this.duration = 0;
            ...
            return this.attribute('fill').valueOrDefault('remove') == 'remove' && !this.removed
              ? ((this.removed = !0), (this.getProperty().value = this.initialValue), !0)
              : !1;
        this.duration += a;
        a = !1;
        ...
        if (d.type == 'font-face')
          ...
          d.arabicForm != ''
            ? ((this.isArabic = this.isRTL = !0),
              typeof this.glyphs[d.unicode] == 'undefined' && (this.glyphs[d.unicode] = []),
      ...
      this.renderChildren = function(b) {
        for (
          ...
          h.attribute('x').hasValue()
            ...
            : (h.attribute('dx').hasValue() && (c += h.attribute('dx').Length.toPixels('x')),
              (h.x = c));
          c = h.measureText(b);
          ...
          h.attribute('y').hasValue()
            ...
            : (h.attribute('dy').hasValue() && (d += h.attribute('dy').Length.toPixels('y')),
              (h.y = d));
          d = h.y;
          h.render(b);
        }
    ...
    a.Element.TextElementBase = function(c) {
      ...
      this.getGlyph = function(a, b, c) {
        ...
        if (a.isArabic) {
          ...
          typeof a.glyphs[e] != 'undefined' &&
            ((f = a.glyphs[e][g]), f == null && a.glyphs[e].type == 'glyph' && (f = a.glyphs[e]));
        } else f = a.glyphs[e];
      ...
      this.renderChildren = function(c) {
        ...
        if (b != null) {
          ...
          c.strokeStyle != '' && c.strokeText(a.compressSpaces(this.getText()), this.x, this.y),
    ...
    a.Element.style = function(c) {
      ...
      for (
        ...
        if (a.trim(c[d]) != '')
          for (
            var b = c[d].split('{'), k = b[0].split(','), b = b[1].split(';'), e = 0;
            e < k.length;
            e++
          ) {
            var f = a.trim(k[e]);
        ...
        for (var j = 0; j < g; j++)
          for (var h = 0; h < f; h++)
            for (var l = a[j * f * 4 + h * 4 + 3] / 255, o = 0; o < 4; o++) {
              for (
                var n =
                    d[0] * (l == 0 ? 255 : a[j * f * 4 + h * 4 + o]) * (l == 0 || o == 3 ? 1 : l),
                  q = 1;
                q < d.length;
                q++
              ) {
        ...
        f = function() {
          ...
          if (a.opts != null && a.opts.scaleWidth != null && a.opts.scaleHeight != null) {
            ...
            k.attribute('width').hasValue() &&
              (f = k.attribute('width').Length.toPixels('x') / a.opts.scaleWidth);
            k.attribute('height').hasValue() &&
              (g = k.attribute('height').Length.toPixels('y') / a.opts.scaleHeight);
    ...
    a.Mouse = new (function() {
      ...
      this.runEvents = function() {
        ...
        for (var c = 0; c < this.events.length; c++)
          for (var d = this.events[c], b = this.eventElements[c]; b; ) d.run(b), (b = b.parent);
        this.events = [];
        this.eventElements = [];
      };
    })();
...
(function(m) {
  ...
  b(c.prototype, {
    ...
    configure: function(b) {
      ...
      d.shadow &&
        (m = k(m, { 'box-shadow': '1px 1px 3px gray', '-webkit-box-shadow': '1px 1px 3px gray' }));
      a(g, m);
