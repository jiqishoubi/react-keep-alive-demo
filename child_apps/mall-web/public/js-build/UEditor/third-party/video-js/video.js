/*! Video.js v4.3.0 Copyright 2013 Brightcove, Inc. https://github.com/videojs/video.js/blob/master/LICENSE */ (function() {
  ...
  u.e = function(a, c) {
    ...
    for (e in c)
      w.call(c, e) &&
        (-1 !== e.indexOf('aria-') || 'role' == e ? d.setAttribute(e, c[e]) : (d[e] = c[e]));
    return d;
  };
  u.$ = function(a) {
  ...
  u.k.ic = function(a, c) {
    ...
    for (d in c)
      w.call(c, d) &&
        ((e = a[d]), (g = c[d]), (a[d] = u.k.qc(e) && u.k.qc(g) ? u.k.ic(e, g) : c[d]));
    return a;
  };
  u.k.copy = function(a) {
    return u.k.B({}, a);
  ...
  u.k.qc = function(a) {
    return (
      !!a && 'object' === typeof a && '[object Object]' === a.toString() && a.constructor === Object
    );
  };
  ...
  u.Kd = function(a, c) {
    ...
    document.defaultView && document.defaultView.getComputedStyle
      ...
      : a.currentStyle && (d = a['client' + c.substr(0, 1).toUpperCase() + c.substr(1)] + 'px');
    return d;
  };
  u.zb = function(a, c) {
  ...
  u.get = function(a, c, d) {
    ...
    g.onreadystatechange = function() {
      4 === g.readyState &&
        (200 === g.status || (e && 0 === g.status) ? c(g.responseText) : d && d());
    };
    try {
      g.send();
    } catch (k) {
  ...
  u.mc = function(a) {
    a.match(/^https?:\/\//) ||
      (a = u.e('div', { innerHTML: '<a href="' + a + '">x</a>' }).firstChild.href);
    return a;
  };
  u.log = function() {
  ...
  t.e = function(a, c) {
    ...
    c = u.k.B(
      { qd: 'slider', 'aria-valuenow': 0, 'aria-valuemin': 0, 'aria-valuemax': 100, tabIndex: 0 },
      c,
    );
    return u.c.prototype.e.call(this, a, c);
  };
  ...
  t.Ka = function() {
    ...
    this.options().title &&
      a.w().appendChild(u.e('li', { className: 'vjs-menu-title', innerHTML: u.$(this.A), zd: -1 }));
  ...
  function I(a, c, d) {
    a.h
      ? ((a.aa = l), a.h.D(), a.Eb && ((a.Eb = l), clearInterval(a.Ra)), a.Fb && J(a), (a.h = l))
      : 'Html5' !== c && a.M && (u.l.jc(a.M), (a.M = h));
    a.ia = c;
    a.aa = l;
    var e = u.k.B({ source: d, parentEl: a.a }, a.g[c.toLowerCase()]);
    d &&
      (d.src == a.v.src && 0 < a.v.currentTime && (e.startTime = a.v.currentTime),
      (a.v.src = d.src));
    ...
    if (a.h && a.h.aa)
      try {
        ...
        throw (a.h[c] === b
          ...
          : 'TypeError' == d.name
          ? (u.log(
              'Video.js: ' + c + ' unavailable on ' + a.ia + ' playback technology element.',
              d,
            ),
            (a.h.aa = l))
          : u.log(d),
  ...
  t.currentTime = function(a) {
    return a !== b
      ? ((this.v.rc = a), L(this, 'setCurrentTime', a), this.Fb && this.j('timeupdate'), this)
  ...
  t.src = function(a) {
    if (a instanceof Array) {
      ...
      c
        ? ((a = c.source), (c = c.h), c == this.ia ? this.src(a) : I(this, c, a))
        : this.a.appendChild(u.e('p', { innerHTML: this.options().notSupportedMessage }));
    } else
      a instanceof Object
  ...
  t.Rb = function(a) {
    return a !== b
      ? ((a = !!a),
        this.Sb !== a &&
          ((this.Sb = a)
            ? (this.n('vjs-using-native-controls'), this.j('usingnativecontrols'))
            : (this.u('vjs-using-native-controls'), this.j('usingcustomcontrols'))),
        this)
      : this.Sb;
  };
  t.error = function() {
  ...
  u.Ya.prototype.Ca = function() {
    ...
    this.content.innerHTML =
      '<span class="vjs-control-text">Current Time </span>' + u.La(a, this.b.duration());
  };
  u.Za = u.c.extend({
    i: function(a, c) {
      u.c.call(this, a, c);
  ...
  u.Za.prototype.Ca = function() {
    ...
    a &&
      (this.content.innerHTML = '<span class="vjs-control-text">Duration Time </span>' + u.La(a));
  };
  u.cc = u.c.extend({
    i: function(a, c) {
      u.c.call(this, a, c);
  ...
  t.e = function() {
    ...
    if (!c || this.m.movingMediaElementInDOM === l)
      c
        ...
        : (c = u.e('video', { id: a.id() + '_html5_api', className: 'vjs-tech' })),
        (c.player = a),
        u.zb(c, a.w());
  ...
  function W(a, c, d) {
    for (var e = a.Aa, g = 0, j = e.length, k, q; g < j; g++)
      (k = e[g]),
        k.id() === c ? (k.show(), (q = k)) : d && k.J() == d && 0 < k.mode() && k.disable();
