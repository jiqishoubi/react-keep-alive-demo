...
(function(Highcharts, UNDEFINED) {
  ...
  wrap(axisProto, 'init', function(proceed, chart, userOptions) {
    ...
    if (!isHidden && (angular || polar)) {
      ...
      this.pane = pane = chart.panes[paneIndex] =
        chart.panes[paneIndex] || new Pane(splat(chartOptions.pane)[paneIndex], chart, axis);
      ...
      this.endAngleRad = endAngleRad =
        ((pick(paneOptions.endAngle, paneOptions.startAngle + 360) - 90) * Math.PI) / 180;
  ...
  wrap(tickProto, 'getLabelPosition', function(
    ...
    var axis = this.axis,
      ...
      angle =
        (((axis.translate(this.pos) + axis.startAngleRad + Math.PI / 2) / Math.PI) * 180) % 360;
