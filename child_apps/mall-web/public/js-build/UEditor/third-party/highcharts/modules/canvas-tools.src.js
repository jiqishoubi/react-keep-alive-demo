      ...
      this.PathParser = new (function(d) {
        ...
        this.addMarker = function(p, from, priorTo) {
          ...
          if (
            ...
            this.angles[this.angles.length - 1] = this.points[this.points.length - 1].angleTo(
              priorTo,
            );
          }
          ...
          for (var x = 0; x < width; x++) {
            ...
            for (var rgba = 0; rgba < 4; rgba++) {
              ...
              for (var i = 1; i < mask.length; i++) {
                ...
                sum +=
                  mask[i] *
                  ((a1 == 0 ? 255 : imGet(src, Math.max(x - i, 0), y, width, height, rgba)) *
                    (a1 == 0 || rgba == 3 ? 1 : a1) +
                    (a2 == 0
                      ? 255
                      : imGet(src, Math.min(x + i, width - 1), y, width, height, rgba)) *
                      (a2 == 0 || rgba == 3 ? 1 : a2));
              }
