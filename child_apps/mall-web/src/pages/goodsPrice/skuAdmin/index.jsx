...
import { Button, Form, Input, Row, Select, Space, Table, Col, DatePicker, Modal, Radio, message, Checkbox, InputNumber } from 'antd'
...
const Index = () => {
  ...
  const columns = [
    ...
    // },
    // {
    //   dataIndex: 'salePersonPhoneNumber',
    //   title: '合伙人手机号',
    //   align: 'center',
    // },
    {
            ...
            <Row gutter={[15, 1]}>
              ...
              <Col span={3}>
                <Form.Item name="orgCode">
                  <FetchSelect
                    placeholder="推广公司"
                    api={'/web/admin/company/queryCompanyList'}
                    valueKey="orgCode"
                    textKey="orgName"
                    //搜索
                    showSearch
              ...
              {/* <Col span={3}>
                <Form.Item name="salePersonName">
                  <Input placeholder="合伙人姓名" />
                </Form.Item>
              </Col>
              <Col span={3}>
                <Form.Item name="salePersonPhoneNumber">
                  <Input placeholder="合伙人手机号" />
                </Form.Item>
              </Col> */}
              <Col span={3}>
        ...
        <>
          <Form onFinish={alterFinish} form={alterForm} labelAlign="right" labelCol={{ span: 8, offset: 1 }}>
            ...
            {/* <Form.Item
              wrapperCol={{ span: 13 }}
              label="合伙人手机号"
              name="salePersonPhoneNumber"
              // rules={[{ required: true, message: '请输入合伙人手机号' }]}
            >
              <Input bordered={false} disabled={true} />
            </Form.Item> */}
            <Form.Item
            ...
            {/*    label="SKU成本价格"*/}
            {/*    name="costPrice"*/}
            {/*    rules={[{ required: true, message: '请输入sku成本价' }]}*/}
            {/*>*/}
            {/*    <InputNumber  style={{width:'100%'}} />*/}
            {/*</Form.Item>*/}
            <Form.Item wrapperCol={{ span: 13 }} label="SKU销售价格" name="salePriceStr" rules={[{ required: true, message: '请输入sku销售价' }]}>
              <InputNumber style={{ width: '100%' }} />
            </Form.Item>
            <Form.Item wrapperCol={{ span: 13 }} label="渠道费" name="distributeRewardFee" rules={[{ required: true, message: '请输入渠道费' }]}>
              <InputNumber style={{ width: '100%' }} />
            </Form.Item>
            <Form.Item wrapperCol={{ span: 13 }} label="SKU销售佣金" name="saleRewardFee" rules={[{ required: true, message: '请输入sku销售佣金' }]}>
              <InputNumber style={{ width: '100%' }} />
            </Form.Item>
