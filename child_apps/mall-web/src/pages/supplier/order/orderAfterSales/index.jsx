...
const Index = (props) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (e) => {
        return (
          <>
            {(e.orderStatus === '20' || e.orderStatus === '50') && <a onClick={() => orderExamine(e)}>审核</a>}
            &nbsp;&nbsp;
  ...
  const goDetails = (e) => {
    router.push({
      pathname: '/web/supplier/trademgr/disputeOrder/details',
      ...
      content: (
        <>
          <Form form={modalForm} preserve={false}>
            <Form.Item name="auditStatus" label="审核状态" initialValue={93} rules={[{ required: true, message: '请选择' }]}>
              <Radio.Group>
